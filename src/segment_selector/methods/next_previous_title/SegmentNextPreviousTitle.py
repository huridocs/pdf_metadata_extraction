...
class SegmentNextPreviousTitle:
    ...
    def get_title_features(self, segment_title: "SegmentNextPreviousTitle"):
        ...
        return [
            ...
            len(segment_title.pdf_segments.pdf_metadata_segments) - segment_title.segment_index,
    ...
    @staticmethod
    def from_pdf_features(pdf_features: PdfMetadata) -> list["SegmentNextPreviousTitle"]:
