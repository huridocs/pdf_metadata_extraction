...
from information_extraction.methods.lightgbm_stack_4_multilingual.SegmentLightgbmStack4Multilingual import (
...
class LightgbmStack4Multilingual:
    ...
    def set_segments(self, pdfs_features: List[PdfFeatures]):
        ...
        for pdf_features in pdfs_features:
            self.segments.extend(SegmentLightgbmStack4Multilingual.from_pdf_features(pdf_features))
