...
class SemanticInformationExtraction:
    ...
    def get_max_input_length(self, multilingual: bool):
        if multilingual:
            sentence_piece = sentencepiece.SentencePieceProcessor(SemanticInformationExtraction.MULTILINGUAL_SENTENCE_PIECE)
        else:
            sentence_piece = sentencepiece.SentencePieceProcessor(SemanticInformationExtraction.ENGLISH_SENTENCE_PIECE)
