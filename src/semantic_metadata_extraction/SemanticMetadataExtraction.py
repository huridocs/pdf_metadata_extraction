...
class SemanticMetadataExtraction:
    ...
    def exists_model(self):
        return exists(self.model_path) or exists(self.multilingual_model_path)
    ...
    def get_max_input_length(self, multilingual: bool):
        if multilingual:
            sentence_piece = sentencepiece.SentencePieceProcessor(SemanticMetadataExtraction.MULTILINGUAL_SENTENCE_PIECE)
        else:
            sentence_piece = sentencepiece.SentencePieceProcessor(SemanticMetadataExtraction.ENGLISH_SENTENCE_PIECE)
