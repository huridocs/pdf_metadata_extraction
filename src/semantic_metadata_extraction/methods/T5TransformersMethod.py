...
from semantic_metadata_extraction.methods.run_seq_2_seq import ModelArguments, DataTrainingArguments, run
...
class T5TransformersMethod(Method):
    ...
    def get_model_path(self):
        return join(self.base_path, "t5_transformers")
    ...
    def train(self, semantic_extraction_data: List[SemanticExtractionData]):
        ...
        data_training_arguments = DataTrainingArguments(
            ...
            max_answer_length=self.get_max_output_length(semantic_extraction_data),
            context_column="input_with_prefix",
            answer_column="target",
            question_column="not_used",
            version_2_with_negative=False,
        )
        seq_seq_training_arguments = Seq2SeqTrainingArguments(
            report_to="none",
        ...
        run(model_arguments, data_training_arguments, seq_seq_training_arguments)
