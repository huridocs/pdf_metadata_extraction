...
class TestRegexMethod(TestCase):
    def test_performance(self):
        semantic_information_data = [
            SemanticExtractionData(text="1981-05-13", segment_text="13 May 1981", language_iso="en") for _ in range(6)
        ]
    ...
    def test_predict(self):
        semantic_information_data = [SemanticExtractionData(text="1982-06-05", segment_text="5 Jun 1982", language_iso="en")]
        date_parser_method = DateParserMethod("date_test", "date_test")
    ...
    def test_predict_multiple_dates_spanish(self):
        ...
        semantic_information_data = [SemanticExtractionData(text="2016-11-30", segment_text=text, language_iso="es")]
        date_parser_method = DateParserMethod("date_test", "date_test")
        date_parser_method.train(semantic_information_data)
    ...
    def test_performance_no_dates(self):
        semantic_information_data = [
            SemanticExtractionData(text="1981-05-13", segment_text="13 May 1981", language_iso="en"),
