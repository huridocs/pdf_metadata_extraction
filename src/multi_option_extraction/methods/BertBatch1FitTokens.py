...
from multi_option_extraction.methods.multi_label_sequence_classification_trainer import (
    multi_label_run,
...
class BertBatch1FitTokens(MultiOptionMethod):
    ...
    def train(self, multi_option_extraction_data: MultiOptionExtractionData):
        ...
        data_training_arguments = MultiLabelDataTrainingArguments(
            ...
            max_seq_length=self.get_token_length(),
