...
from multi_option_extraction.text_to_multi_option_methods.EarlyStoppingAfterInitialTraining import EarlyStoppingAfterInitialTraining
...
class BertSeqSteps(TextToMultiOptionMethod):
    ...
    def train(self, multi_option_extraction_data: MultiOptionExtractionData):
        ...
        training_args = TrainingArguments(
            ...
            max_steps=self.get_max_steps(multi_option_extraction_data),
            weight_decay=0.01,
            eval_steps=200,
            save_steps=200,
            save_strategy="steps",
