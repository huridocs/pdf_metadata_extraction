...
class TextToMultiOptionMethod(ABC):
    ...
    @staticmethod
    def get_max_steps(multi_option_extraction_data: MultiOptionExtractionData):
        steps = math.ceil(23 * len(multi_option_extraction_data.samples) / 200) * 200
