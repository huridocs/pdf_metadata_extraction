...
class SetFitMethod(MultiLabelMethods):
    ...
    def get_dataset_from_data(self, multi_option_data: MultiOptionData):
        data = list()
    ...
    def train(self, multi_option_data: MultiOptionData):
        train_dataset = self.get_dataset_from_data(multi_option_data)
