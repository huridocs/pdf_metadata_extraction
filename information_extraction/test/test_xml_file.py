...
class TestXmlFile(TestCase):
    ...
    def test_save_xml_to_train(self):
        ...
        with open(self.test_file_path, 'rb') as file:
            xml_file = XmlFile(tenant=tenant,
    ...
    def test_get_segments_should_be_empty_when_no_file_because_different_property_name(self):
        tenant = "tenant_save"
        property_name = 'property_save'
        ...
        segmentation_data = SegmentationData(
            ...
            label_segments_boxes=[
                SegmentBox(left=0.49019, top=0.37878, width=0.008169, height=0.0126,
                           page_number=2)])
        with open(self.test_file_path, 'rb') as file:
            XmlFile(tenant=tenant,
                    property_name='different_property_name',
                    to_train=False,
                    xml_file_name='test.xml').save(file=file.read())
